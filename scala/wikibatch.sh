...
/home/hadoop/hadoop/bin/hadoop jar ./target/scala_2.8.1/wikicrunch_2.8.1-1.0.min.jar org.seacourt.wikibatch.WikiBatch -Dmapreduce.jobtracker.maxmapmemory.mb=2024 enwikifull.seq wikiBatch 50
