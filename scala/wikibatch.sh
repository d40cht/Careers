...
export LD_LIBRARY_PATH=/home/alex/Devel/AW/optimal/scala/lib
...
java -Xmx2000M -cp target/scala_2.8.1/wikicrunch_2.8.1-1.0.min.jar PhraseMap wikiBatch/ DisambigData/dbout.sqlite
